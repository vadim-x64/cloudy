        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              ...
              '• Динамічні фони - розумні градієнти та lottie-анімації, що плавно адаптуються під час доби (світанок, ранок, день, вечір, ніч) та поточні погодні умови.\n'
              '• Анімовані іконки та UI - унікальні кастомні іконки, інтерактивний термометр, математично згенеровані ефекти (дощ, сніг, блискавки, полярне сяйво, туман) та ефект матового скла.\n'
        ...
        child: Column(
          children: [
            _buildInteractiveTechItem(
              ...
              title: 'Інтерактивний ШІ-Асистент',
              subtitle: 'Хмарна велика мовна модель (LLM)',
              description:
                  'Користувач спілкується з розумним помічником у форматі живого чату. Під капотом застосунок формує системний контекст із поточними метеоданими (температура, вологість, вітер, AQI), тому асистент завжди знає реальну погоду за вікном і відповідає на запити максимально влучно.',
            ),
            const Divider(color: Colors.white24, height: 24),
            _buildInteractiveTechItem(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _buildTechChip('Cloud LLM API', Colors.deepPurple),
